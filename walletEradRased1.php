            ...
            <section class="main-content">
               <div class="container">
                  ...
                  <div class="row">
					  ...
					  <div class=" col-md-8 col-lg-8 col-sm-8 col-12">	
						...
						<div class="col-md-4 col-lg-4 col-sm-12 col-12" >
						 ...
						 <div class="col-md-4 col-lg-4 col-sm-12 col-12" >
							<a style="background-color:#5051f9;" class="custom-box1" href="walletEradRased1.php"> <div >
							   <div class="custom-box1-head">
								  <h4 style="font-size:15px;margin-bottom:10px;color:white">  Balance Transfer Commission </h4>
								  
							   </div>
							   <div class="custom-box1-data" style="display: flex;justify-content: center;align-items: center;">
								  <h4 style="color:white"> <?php echo $BalanceTraComm; ?> MAD </h4>
							   </div>
							</div></a>
						 </div>
						 <div class="col-md-4 col-lg-4 col-sm-12 col-12"  >
                     ...
                     <div class="col-md-12 col-lg-12 col-sm-12 col-12 ">
                        <div class="custom-block3">
                           ...
                           <div class="table-wrapper">
                              <table class="table-1">
                                 <thead>
                                    <tr >
									   ...
									   <th style="color:black;"class="text-center"> Total Money </th>
									   <th style="color:black;"class="text-center"> Fees </th>
                            ...
                            <?php
                                    ...
                                    if($ShopNamew == ''){
                                        $res = mysqli_query($con,"SELECT * FROM SendMoneyTransactions JOIN Users ON SendMoneyTransactions.UserID = Users.UserID order by SendMoneyTransactionsID desc limit $rr,10");
                                    }else{
                                        $rr = 0;
                            ...
                            while($row = mysqli_fetch_assoc($res)){
									...
									$CuttenMoney	 = $row["CuttenMoney"];
									$CreatedAtFeesTransaction = $row["CreatedAtSendMoneyTransactions"];
                                ...
                                ?>
                                  ...
                                  <tr>
									   ...
									   <td class="col-grey1 text-center"> <?php echo $CuttenMoney; ?> MAD </td>
                        ...
                        <div class="block-element m-b-40">
                           <div class="custom-pagination">
                              ...
                              <ul>
                                 <li> <a href="walletEradRased1.php?ShopName=<?php echo $ShopNamew ?>&Page=<?php echo $Page-1 ?>&CityName=<?php echo $CityName ?>&cityID=<?php echo $cityID ?>"> <i class="fa fa-angle-left"> </i> </a> </li>
                                 <li> <a href="#" class="active"> <?php echo $Page+1 ?> </a> </li>
                                 <li> <a href="walletEradRased1.php?ShopName=<?php echo $ShopNamew ?>&Page=<?php echo $Page+1 ?>&CityName=<?php echo $CityName ?>&cityID=<?php echo $cityID ?>"> <i class="fa fa-angle-right"> </i> </a> </li>
                              </ul>
                           </div>
                        </div>
                     </div>
					 ...
					 <div class="col-md-4 col-lg-4 col-sm-4 col-12">
					 	...
					 	<div >
								...
								<div class="card-header">
									<div class="card-title">Balance Transfer commetion
</div>
								</div>
								<div class="card-body">
                  ...
                  $M1 = 0 ;$M2 = 0 ;$M3 = 0 ;$M4 = 0 ; $M5 = 0 ;$M6 = 0 ;$M7 = 0 ;$M8 = 0 ; $M9 = 0 ;$M10 = 0 ;$M11 = 0 ;$M12 = 0 ;
                                $res = mysqli_query($con,"SELECT MONTH(CreatedAtSendMoneyTransactions) AS Month, COUNT(*) AS TotalOrders FROM SendMoneyTransactions WHERE YEAR(CreatedAtSendMoneyTransactions) = '$currentYear' GROUP BY MONTH(CreatedAtSendMoneyTransactions);");
                    ...
                    ?>            
                        ...
                        <div class="custom-block1 height-box1">
                           <div class="block-element">
                              <div class="sec-head1">
                                 <h4 class="col-green1"> Balance Transfer commetion </h4>
						   ...
						   $res = mysqli_query($con,"SELECT SendMoneyPerc FROM OrdersJiblerpercentage");
							...
							$res = mysqli_query($con,"SELECT count(*) FROM SendMoneyTransactions");
                           ...
                           <div class="block-element">
                              <div class="profit-block profit-bg1">
                                 ...
                                 <h6 class="col-green2"> Balance Transfer commetion  </h6>
                                 <h4> <?php echo $SendMoneyPerc; ?>% </h4>
                              </div>
							  <div class="profit-block profit-bg1">
                                 <img src="images/profit-icon1.png">
                                 <h6 class="col-green2"> numbers  </h6>
                                 <h4> <?php echo $counttt; ?> </h4>
                              </div>
                              
                           </div>
                           <div class="block-element tags-holder"style="margin-top:10px">
                              <a href="" class="bg-blue1 tag-block"> <?php echo $BalanceTraComm; ?> MAD <span> Income </span> </a>	
                           </div>
                        </div>
                     </div>
