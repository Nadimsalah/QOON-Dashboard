               ...
               <div class="container">
                  ...
                  <div class="row">
					  ...
					  <div class=" col-md-8 col-lg-8 col-sm-8 col-12">	
						 ...
						 <div class="col-md-4 col-lg-4 col-sm-12 col-12" >
							<a style="background-color:#5051f9;" class="custom-box1" href="walletEradRased3.php"> <div >
							   <div class="custom-box1-head">
								  <h4 style="font-size:15px;margin-bottom:10px;color:white">  Service Commission </h4>
								  
							   </div>
							   <div class="custom-box1-data" style="display: flex;justify-content: center;align-items: center;">
								  <h4 style="color:white"> <?php echo $ServComm; ?> MAD </h4>
							   </div>
							</div></a>
						 </div>
						 </div>
                     ...
                     <div class="col-md-12 col-lg-12 col-sm-12 col-12 ">
                        ...
                        <div class="block-element m-b-40">
                           <div class="custom-pagination">
                              ...
                              <ul>
                                 <li> <a href="walletEradRased3.php?ShopName=<?php echo $ShopNamew ?>&Page=<?php echo $Page-1 ?>&CityName=<?php echo $CityName ?>&cityID=<?php echo $cityID ?>"> <i class="fa fa-angle-left"> </i> </a> </li>
                                 <li> <a href="#" class="active"> <?php echo $Page+1 ?> </a> </li>
                                 <li> <a href="walletEradRased3.php?ShopName=<?php echo $ShopNamew ?>&Page=<?php echo $Page+1 ?>&CityName=<?php echo $CityName ?>&cityID=<?php echo $cityID ?>"> <i class="fa fa-angle-right"> </i> </a> </li>
                              </ul>
                           </div>
                        </div>
                     </div>
