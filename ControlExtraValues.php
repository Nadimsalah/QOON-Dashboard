         ...
         <main class="right-content">
            ...
            <section class="main-content">
               <div class="container">
                                 ...
                                 <form action="AddExtraInSideCategotyApi.php" method="POST">
                                    <div class="row category-adding">
                                       <div class="col-md-9 col-lg-9 col-sm-9 col-12">
                                          <input type="text" class="field-style2" placeholder="Name" name="Name">
										  <input type="number" class="field-style2" placeholder="Price" name="Price">
                                          <input type="hidden" class="field-style2" placeholder="Add Category" name="ExtraCategoryID" value="<?php echo $id ?>">
                                       </div>
				...
				$var = rand(50,150);
                              $res = mysqli_query($con,"SELECT SQL_NO_CACHE * FROM ExtraInSideCategoty WHERE ExtraCategoryID='$id'");
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                                ...
                                ?> 
                                          ...
                                          <tr>
                                             <td> <span class="category-name"> <?php echo $row["Name"] ?> </span> </td>
											 <td> <span class="text-center"> <?php echo $row["Price"] ?> </span> </td>
                                             <td class="text-center"> <button class="category-name" style="backgound:white;"><a href="DeleteExtraValueApi.php?id=<?php echo $row["ExtraInSideCategotyID"] ?>&prodid=<?php echo $id ?>"> Delete </a></button> </td>
                                          </tr>
                                <?php } ?>          
                                       </tbody>
                                    </table>
