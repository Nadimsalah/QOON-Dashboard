      ...
      <section class="all-content">
         ...
         <main class="right-content">
            ...
            <section class="main-content">
               <form method="POST" action="AddCategoryAPI.php" enctype="multipart/form-data" class="container">
                  <div class="row m-b-20 m-t-30">
                     <div class="col-md-12 col-lg-12 col-sm-12 col-12">
                        <div class="title-text1">
                           <h4 class="col-black"> Add Categoty </h4>
                        </div>
                     </div>
                  </div>
                  <div class="row">
        ...
        <div class="avatar-preview">
            <div id="imagePreview" style="background-image: url(images/photo-icon.png);">
                  ...
                  <input type="number" placeholder="priority" class="field-style1" name="Priority">
                  </div>
                  ...
                  <div class="form-field1">
                  <input type="text" placeholder="Arabic" class="field-style1" name="Arabic">
                  </div>   
                  </div> 

                  <div class="col-md-6 col-lg-6 col-sm-12 col-12">
                  <div class="form-field1">
                  <input type="text" placeholder="French" class="field-style1" name="French">
                  </div>  
                  <div class="form-field1">
                  <input type="text" placeholder="SearchKey" class="field-style1" name="English">
                  </div>
                  </div> 
