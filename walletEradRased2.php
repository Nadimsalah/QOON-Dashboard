...
?>							
                  ...
                  <div class="row">
					  ...
					  <div class=" col-md-8 col-lg-8 col-sm-8 col-12">	
						 ...
						 <div class="col-md-4 col-lg-4 col-sm-12 col-12" >
							<a style="background-color:#5051f9;" class="custom-box1" href="walletEradRased2.php"> <div >
							   <div class="custom-box1-head">
								  <h4 style="font-size:15px;margin-bottom:10px;color:white">  Balance Withdrawal Commission </h4>
								  
							   </div>
							   <div class="custom-box1-data" style="display: flex;justify-content: center;align-items: center;">
								  <h4 style="color:white"> <?php echo $BalanceWithComm; ?> MAD </h4>
							   </div>
							</div></a>
						 </div>
						 <div class="col-md-4 col-lg-4 col-sm-12 col-12" >
                     ...
                     <div class="col-md-12 col-lg-12 col-sm-12 col-12 ">
                        <div class="custom-block3">
                           ...
                           <div class="table-wrapper">
                            ...
                            <?php
                                    ...
                                    if($ShopNamew == ''){
                                        $res = mysqli_query($con,"SELECT * FROM SendMoneyTransactions JOIN Users ON SendMoneyTransactions.UserID = Users.UserID WHERE Users.UserID = 0 order by SendMoneyTransactionsID desc limit $rr,10");
                                    }else{
                                        $rr = 0;
                        ...
                        <div class="block-element m-b-40">
                           <div class="custom-pagination">
                              ...
                              <ul>
                                 <li> <a href="walletEradRased2.php?ShopName=<?php echo $ShopNamew ?>&Page=<?php echo $Page-1 ?>&CityName=<?php echo $CityName ?>&cityID=<?php echo $cityID ?>"> <i class="fa fa-angle-left"> </i> </a> </li>
                                 <li> <a href="#" class="active"> <?php echo $Page+1 ?> </a> </li>
                                 <li> <a href="walletEradRased2.php?ShopName=<?php echo $ShopNamew ?>&Page=<?php echo $Page+1 ?>&CityName=<?php echo $CityName ?>&cityID=<?php echo $cityID ?>"> <i class="fa fa-angle-right"> </i> </a> </li>
                              </ul>
                           </div>
                        </div>
                     </div>
                 ...
                 /* $currentYear = date('Y');
                  ...
                  $M1 = 0 ;$M2 = 0 ;$M3 = 0 ;$M4 = 0 ; $M5 = 0 ;$M6 = 0 ;$M7 = 0 ;$M8 = 0 ; $M9 = 0 ;$M10 = 0 ;$M11 = 0 ;$M12 = 0 ;
                                $res = mysqli_query($con,"SELECT MONTH(CreatedAtBooking) AS Month, COUNT(*) AS TotalOrders FROM Booking WHERE YEAR(CreatedAtBooking) = '$currentYear' GROUP BY MONTH(CreatedAtBooking);");
                    ...
                    ?>            
                        ...
                        <div class="custom-block1 height-box1">
						   ...
						   $res = mysqli_query($con,"SELECT SendMoneyPerc,getMoneyPerc FROM OrdersJiblerpercentage");
                           ...
                           <div class="block-element tags-holder" style="margin-top:10px;">
                              <a href="" class="bg-blue1 tag-block"> <?php echo $BalanceWithComm; ?> MAD <span> Income </span> </a>	
                           </div>
                        </div>
                     </div>
